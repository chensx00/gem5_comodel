...
#ifndef VERILATED_VCHECKSUMXCELRTL_H_
#define VERILATED_VCHECKSUMXCELRTL_H_  // guard

#include "verilated.h"

class VChecksumXcelRTL__Syms;
class VChecksumXcelRTL___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VChecksumXcelRTL VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VChecksumXcelRTL___024root* const rootp;
    ...
    explicit VChecksumXcelRTL(VerilatedContext* contextp, const char* name = "TOP");
    explicit VChecksumXcelRTL(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VChecksumXcelRTL();
  private:
    VL_UNCOPYABLE(VChecksumXcelRTL);  ///< Copying not allowed
